      ...
      <div className="flex justify-center">
        ...
        >
          ...
          <div className="text-center">
            <p  onClick={() => handleRedirect("/lok-sabha")} className="text-xl text-black cursor-pointer">LokShabha</p>
          </div>
        </div>
        ...
        >
          ...
          />
          <div className="text-center">
            <p     onClick={() => handleRedirect("/rajya-sabha")} className="text-xl text-black cursor-pointer">RajyaShabha</p>
          </div>
        </div>
      </div>
